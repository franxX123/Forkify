...
class RecipeView extends View {
  ...
  // Implements a subscriber-publisher pattern. To make sure the UI and Controller content are separated.
  // THe callback is from the controller and the events are coming from the UI.
  ...
  addHandlerServing(handler) {
    this._parentElement.addEventListener('click', function (e) {
      ...
      const updatedServings = +btn.dataset.updateTo;
